        ...
        <section className="wrapper meo " style={{ backgroundColor: 'white', fontFamily: 'Poppins', paddingTop: '107px' }} >
            <div className="wrapper">
                ...
                <div className="container ">
                    <h1 className='fw-bold text-center he' style={{ color: 'black', zIndex: '2', position: 'relative' }}>Events</h1>
                    <h3 className="text-center mt-4 fw-bold" style={{ color: 'rgb(81, 42, 116)', zIndex: '2', position: 'relative' }}>Our Charity Events: Celebrating Our Impact Together</h3>
                            ...
                            <div class={`image-flip ${animate ? 'card3' : ''}`} >
                                <div className="mainflip flip-0">
                                    <div className="frontside">
                                        <div className="card" style={{ width: '22rem', border: '15px solid white', boxShadow: 'rgb(244 255 0) 0px 0px 20px' }}>
                                    ...
                                    <div className="backside">
                                        <div className="card" style={{ width: '22rem', boxShadow: ' rgb(244 255 0) 0px 0px 20px', backgroundColor: '#D15D0E' }}>
